...
#import "SJSystemEnum.h"
#import "UIButton+SJExtensions.h"
...
+ (void)showMoreWithTitle:(NSArray *)titleArray
    ...
    SJShareView *modeView = [[SJShareView alloc] initWithFrame:CGRectMake(0, 0, MIN(ScreenWidth, ScreenHeight), MAX(ScreenWidth, ScreenHeight))];
...
//    }
    ...
    self.contentView = [[UIView alloc] initWithFrame:CGRectMake(0, MAX(ScreenWidth, ScreenHeight), MIN(ScreenWidth, ScreenHeight), ShareHeight)];
...
- (void)bulidCancle{
    ...
    cancleButton.titleLabel.font = [SJSystemEnum getPingFangSCRegularFontWithSize:16];
...
//    }
    ...
    for (int i = 0; i < self.titleArray.count; i++) {
        ...
        titleLab.font = [SJSystemEnum getPingFangSCRegularFontWithSize:12];
